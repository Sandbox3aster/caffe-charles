 ...
 * input to a EuclideanNewLossLayer exactly formulates a linear least squares
...
class EuclideanNewLossLayer : public Layer<Dtype> {
 public:
  explicit EuclideanNewLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "EuclideanNewLoss"; }
  /**
   * Unlike most loss layers, in the EuclideanNewLossLayer we can backpropagate
