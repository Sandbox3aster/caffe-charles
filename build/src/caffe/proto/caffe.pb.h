...
class BNParameter;
class LocalConvolutionParameter;
...
class EuclideanNewLossLayerParam;
...
enum BNParameter_Type {
  BNParameter_Type_CHANNEL_WISE = 0,
  BNParameter_Type_ELEMENT_WISE = 1
};
bool BNParameter_Type_IsValid(int value);
const BNParameter_Type BNParameter_Type_Type_MIN = BNParameter_Type_CHANNEL_WISE;
const BNParameter_Type BNParameter_Type_Type_MAX = BNParameter_Type_ELEMENT_WISE;
const int BNParameter_Type_Type_ARRAYSIZE = BNParameter_Type_Type_MAX + 1;

const ::google::protobuf::EnumDescriptor* BNParameter_Type_descriptor();
inline const ::std::string& BNParameter_Type_Name(BNParameter_Type value) {
  return ::google::protobuf::internal::NameOfEnum(
    BNParameter_Type_descriptor(), value);
}
inline bool BNParameter_Type_Parse(
    const ::std::string& name, BNParameter_Type* value) {
  return ::google::protobuf::internal::ParseNamedEnum<BNParameter_Type>(
    BNParameter_Type_descriptor(), name, value);
}
enum LocalConvolutionParameter_Engine {
  LocalConvolutionParameter_Engine_DEFAULT = 0,
  LocalConvolutionParameter_Engine_CAFFE = 1,
  LocalConvolutionParameter_Engine_CUDNN = 2
};
bool LocalConvolutionParameter_Engine_IsValid(int value);
const LocalConvolutionParameter_Engine LocalConvolutionParameter_Engine_Engine_MIN = LocalConvolutionParameter_Engine_DEFAULT;
const LocalConvolutionParameter_Engine LocalConvolutionParameter_Engine_Engine_MAX = LocalConvolutionParameter_Engine_CUDNN;
const int LocalConvolutionParameter_Engine_Engine_ARRAYSIZE = LocalConvolutionParameter_Engine_Engine_MAX + 1;

const ::google::protobuf::EnumDescriptor* LocalConvolutionParameter_Engine_descriptor();
inline const ::std::string& LocalConvolutionParameter_Engine_Name(LocalConvolutionParameter_Engine value) {
  return ::google::protobuf::internal::NameOfEnum(
    LocalConvolutionParameter_Engine_descriptor(), value);
}
inline bool LocalConvolutionParameter_Engine_Parse(
    const ::std::string& name, LocalConvolutionParameter_Engine* value) {
  return ::google::protobuf::internal::ParseNamedEnum<LocalConvolutionParameter_Engine>(
    LocalConvolutionParameter_Engine_descriptor(), name, value);
}
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.LocalConvolutionParameter local_conv_param = 148;
  inline bool has_local_conv_param() const;
  inline void clear_local_conv_param();
  static const int kLocalConvParamFieldNumber = 148;
  inline const ::caffe::LocalConvolutionParameter& local_conv_param() const;
  inline ::caffe::LocalConvolutionParameter* mutable_local_conv_param();
  inline ::caffe::LocalConvolutionParameter* release_local_conv_param();
  inline void set_allocated_local_conv_param(::caffe::LocalConvolutionParameter* local_conv_param);
  ...
  // optional .caffe.EuclideanNewLossLayerParam euclidean_new_loss_param = 161;
  inline bool has_euclidean_new_loss_param() const;
  inline void clear_euclidean_new_loss_param();
  static const int kEuclideanNewLossParamFieldNumber = 161;
  inline const ::caffe::EuclideanNewLossLayerParam& euclidean_new_loss_param() const;
  inline ::caffe::EuclideanNewLossLayerParam* mutable_euclidean_new_loss_param();
  inline ::caffe::EuclideanNewLossLayerParam* release_euclidean_new_loss_param();
  inline void set_allocated_euclidean_new_loss_param(::caffe::EuclideanNewLossLayerParam* euclidean_new_loss_param);
 ...
 private:
  ...
  inline void set_has_local_conv_param();
  inline void clear_has_local_conv_param();
  ...
  inline void set_has_euclidean_new_loss_param();
  inline void clear_has_euclidean_new_loss_param();
  ...
  ::caffe::LocalConvolutionParameter* local_conv_param_;
  ...
  ::caffe::EuclideanNewLossLayerParam* euclidean_new_loss_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class BNParameter : public ::google::protobuf::Message {
 public:
  ...
  typedef BNParameter_Type Type;
  static const Type CHANNEL_WISE = BNParameter_Type_CHANNEL_WISE;
  static const Type ELEMENT_WISE = BNParameter_Type_ELEMENT_WISE;
  static inline bool Type_IsValid(int value) {
    return BNParameter_Type_IsValid(value);
  }
  static const Type Type_MIN =
    BNParameter_Type_Type_MIN;
  static const Type Type_MAX =
    BNParameter_Type_Type_MAX;
  static const int Type_ARRAYSIZE =
    BNParameter_Type_Type_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  Type_descriptor() {
    return BNParameter_Type_descriptor();
  }
  static inline const ::std::string& Type_Name(Type value) {
    return BNParameter_Type_Name(value);
  }
  static inline bool Type_Parse(const ::std::string& name,
      Type* value) {
    return BNParameter_Type_Parse(name, value);
  }
  ...
  // optional int32 average_span = 3 [default = 10];
  inline bool has_average_span() const;
  inline void clear_average_span();
  static const int kAverageSpanFieldNumber = 3;
  inline ::google::protobuf::int32 average_span() const;
  inline void set_average_span(::google::protobuf::int32 value);

  // optional float exponential_average_weight = 4 [default = 0.001];
  inline bool has_exponential_average_weight() const;
  inline void clear_exponential_average_weight();
  static const int kExponentialAverageWeightFieldNumber = 4;
  inline float exponential_average_weight() const;
  inline void set_exponential_average_weight(float value);

  // optional .caffe.BNParameter.Type bn_type = 5 [default = CHANNEL_WISE];
  inline bool has_bn_type() const;
  inline void clear_bn_type();
  static const int kBnTypeFieldNumber = 5;
  inline ::caffe::BNParameter_Type bn_type() const;
  inline void set_bn_type(::caffe::BNParameter_Type value);
 ...
 private:
  ...
  inline void set_has_average_span();
  inline void clear_has_average_span();
  inline void set_has_exponential_average_weight();
  inline void clear_has_exponential_average_weight();
  inline void set_has_bn_type();
  inline void clear_has_bn_type();
  ...
  ::google::protobuf::int32 average_span_;
  float exponential_average_weight_;
  int bn_type_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
class LocalConvolutionParameter : public ::google::protobuf::Message {
 public:
  LocalConvolutionParameter();
  virtual ~LocalConvolutionParameter();

  LocalConvolutionParameter(const LocalConvolutionParameter& from);

  inline LocalConvolutionParameter& operator=(const LocalConvolutionParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const LocalConvolutionParameter& default_instance();

  void Swap(LocalConvolutionParameter* other);

  // implements Message ----------------------------------------------

  LocalConvolutionParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const LocalConvolutionParameter& from);
  void MergeFrom(const LocalConvolutionParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  typedef LocalConvolutionParameter_Engine Engine;
  static const Engine DEFAULT = LocalConvolutionParameter_Engine_DEFAULT;
  static const Engine CAFFE = LocalConvolutionParameter_Engine_CAFFE;
  static const Engine CUDNN = LocalConvolutionParameter_Engine_CUDNN;
  static inline bool Engine_IsValid(int value) {
    return LocalConvolutionParameter_Engine_IsValid(value);
  }
  static const Engine Engine_MIN =
    LocalConvolutionParameter_Engine_Engine_MIN;
  static const Engine Engine_MAX =
    LocalConvolutionParameter_Engine_Engine_MAX;
  static const int Engine_ARRAYSIZE =
    LocalConvolutionParameter_Engine_Engine_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  Engine_descriptor() {
    return LocalConvolutionParameter_Engine_descriptor();
  }
  static inline const ::std::string& Engine_Name(Engine value) {
    return LocalConvolutionParameter_Engine_Name(value);
  }
  static inline bool Engine_Parse(const ::std::string& name,
      Engine* value) {
    return LocalConvolutionParameter_Engine_Parse(name, value);
  }
  ...
  // repeated uint32 dilation = 25;
  inline int dilation_size() const;
  inline void clear_dilation();
  static const int kDilationFieldNumber = 25;
  ...
  // optional .caffe.LocalConvolutionParameter.Engine engine = 15 [default = DEFAULT];
  inline bool has_engine() const;
  inline void clear_engine();
  static const int kEngineFieldNumber = 15;
  inline ::caffe::LocalConvolutionParameter_Engine engine() const;
  inline void set_engine(::caffe::LocalConvolutionParameter_Engine value);

  // optional uint32 local_region_number = 16 [default = 1];
  inline bool has_local_region_number() const;
  inline void clear_local_region_number();
  static const int kLocalRegionNumberFieldNumber = 16;
  inline ::google::protobuf::uint32 local_region_number() const;
  inline void set_local_region_number(::google::protobuf::uint32 value);

  // optional uint32 local_region_number_w = 17 [default = 1];
  inline bool has_local_region_number_w() const;
  inline void clear_local_region_number_w();
  static const int kLocalRegionNumberWFieldNumber = 17;
  inline ::google::protobuf::uint32 local_region_number_w() const;
  inline void set_local_region_number_w(::google::protobuf::uint32 value);

  // optional uint32 local_region_number_h = 18 [default = 1];
  inline bool has_local_region_number_h() const;
  inline void clear_local_region_number_h();
  static const int kLocalRegionNumberHFieldNumber = 18;
  inline ::google::protobuf::uint32 local_region_number_h() const;
  inline void set_local_region_number_h(::google::protobuf::uint32 value);

  // optional float local_region_ratio = 19 [default = 1];
  inline bool has_local_region_ratio() const;
  inline void clear_local_region_ratio();
  static const int kLocalRegionRatioFieldNumber = 19;
  inline float local_region_ratio() const;
  inline void set_local_region_ratio(float value);

  // optional float local_region_ratio_w = 20 [default = 1];
  inline bool has_local_region_ratio_w() const;
  inline void clear_local_region_ratio_w();
  static const int kLocalRegionRatioWFieldNumber = 20;
  inline float local_region_ratio_w() const;
  inline void set_local_region_ratio_w(float value);

  // optional float local_region_ratio_h = 21 [default = 1];
  inline bool has_local_region_ratio_h() const;
  inline void clear_local_region_ratio_h();
  static const int kLocalRegionRatioHFieldNumber = 21;
  inline float local_region_ratio_h() const;
  inline void set_local_region_ratio_h(float value);

  // optional uint32 local_region_step = 22 [default = 1];
  inline bool has_local_region_step() const;
  inline void clear_local_region_step();
  static const int kLocalRegionStepFieldNumber = 22;
  inline ::google::protobuf::uint32 local_region_step() const;
  inline void set_local_region_step(::google::protobuf::uint32 value);

  // optional uint32 local_region_step_w = 23 [default = 1];
  inline bool has_local_region_step_w() const;
  inline void clear_local_region_step_w();
  static const int kLocalRegionStepWFieldNumber = 23;
  inline ::google::protobuf::uint32 local_region_step_w() const;
  inline void set_local_region_step_w(::google::protobuf::uint32 value);

  // optional uint32 local_region_step_h = 24 [default = 1];
  inline bool has_local_region_step_h() const;
  inline void clear_local_region_step_h();
  static const int kLocalRegionStepHFieldNumber = 24;
  inline ::google::protobuf::uint32 local_region_step_h() const;
  inline void set_local_region_step_h(::google::protobuf::uint32 value);

  // @@protoc_insertion_point(class_scope:caffe.LocalConvolutionParameter)
 private:
  ...
  inline void set_has_local_region_number();
  inline void clear_has_local_region_number();
  inline void set_has_local_region_number_w();
  inline void clear_has_local_region_number_w();
  inline void set_has_local_region_number_h();
  inline void clear_has_local_region_number_h();
  inline void set_has_local_region_ratio();
  inline void clear_has_local_region_ratio();
  inline void set_has_local_region_ratio_w();
  inline void clear_has_local_region_ratio_w();
  inline void set_has_local_region_ratio_h();
  inline void clear_has_local_region_ratio_h();
  inline void set_has_local_region_step();
  inline void clear_has_local_region_step();
  inline void set_has_local_region_step_w();
  inline void clear_has_local_region_step_w();
  inline void set_has_local_region_step_h();
  inline void clear_has_local_region_step_h();
  ...
  int engine_;
  ::google::protobuf::uint32 local_region_number_;
  ::google::protobuf::uint32 local_region_number_w_;
  ::google::protobuf::uint32 local_region_number_h_;
  float local_region_ratio_;
  float local_region_ratio_w_;
  float local_region_ratio_h_;
  ::google::protobuf::uint32 local_region_step_;
  ::google::protobuf::uint32 local_region_step_w_;
  ::google::protobuf::uint32 local_region_step_h_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static LocalConvolutionParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class DataParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional uint32 task_num = 11 [default = 1];
  inline bool has_task_num() const;
  inline void clear_task_num();
  static const int kTaskNumFieldNumber = 11;
  inline ::google::protobuf::uint32 task_num() const;
  inline void set_task_num(::google::protobuf::uint32 value);

  // repeated uint32 label_dimension = 12;
  inline int label_dimension_size() const;
  inline void clear_label_dimension();
  static const int kLabelDimensionFieldNumber = 12;
  inline ::google::protobuf::uint32 label_dimension(int index) const;
  inline void set_label_dimension(int index, ::google::protobuf::uint32 value);
  inline void add_label_dimension(::google::protobuf::uint32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      label_dimension() const;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_label_dimension();
 ...
 private:
  ...
  inline void set_has_task_num();
  inline void clear_has_task_num();
  ...
  ::google::protobuf::uint32 task_num_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > label_dimension_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
class EuclideanNewLossLayerParam : public ::google::protobuf::Message {
 public:
  EuclideanNewLossLayerParam();
  virtual ~EuclideanNewLossLayerParam();

  EuclideanNewLossLayerParam(const EuclideanNewLossLayerParam& from);

  inline EuclideanNewLossLayerParam& operator=(const EuclideanNewLossLayerParam& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const EuclideanNewLossLayerParam& default_instance();

  void Swap(EuclideanNewLossLayerParam* other);

  // implements Message ----------------------------------------------

  EuclideanNewLossLayerParam* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const EuclideanNewLossLayerParam& from);
  void MergeFrom(const EuclideanNewLossLayerParam& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional int32 net_size = 1 [default = 5];
  inline bool has_net_size() const;
  inline void clear_net_size();
  static const int kNetSizeFieldNumber = 1;
  inline ::google::protobuf::int32 net_size() const;
  inline void set_net_size(::google::protobuf::int32 value);

  // @@protoc_insertion_point(class_scope:caffe.EuclideanNewLossLayerParam)
 private:
  inline void set_has_net_size();
  inline void clear_has_net_size();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::int32 net_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static EuclideanNewLossLayerParam* default_instance_;
};
// ===================================================================
...
// optional .caffe.LocalConvolutionParameter local_conv_param = 148;
inline bool LayerParameter::has_local_conv_param() const {
  return (_has_bits_[1] & 0x00000020u) != 0;
}
inline void LayerParameter::set_has_local_conv_param() {
  _has_bits_[1] |= 0x00000020u;
}
inline void LayerParameter::clear_has_local_conv_param() {
  _has_bits_[1] &= ~0x00000020u;
}
inline void LayerParameter::clear_local_conv_param() {
  if (local_conv_param_ != NULL) local_conv_param_->::caffe::LocalConvolutionParameter::Clear();
  clear_has_local_conv_param();
}
inline const ::caffe::LocalConvolutionParameter& LayerParameter::local_conv_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.local_conv_param)
  return local_conv_param_ != NULL ? *local_conv_param_ : *default_instance_->local_conv_param_;
}
inline ::caffe::LocalConvolutionParameter* LayerParameter::mutable_local_conv_param() {
  set_has_local_conv_param();
  if (local_conv_param_ == NULL) local_conv_param_ = new ::caffe::LocalConvolutionParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.local_conv_param)
  return local_conv_param_;
}
inline ::caffe::LocalConvolutionParameter* LayerParameter::release_local_conv_param() {
  clear_has_local_conv_param();
  ::caffe::LocalConvolutionParameter* temp = local_conv_param_;
  local_conv_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_local_conv_param(::caffe::LocalConvolutionParameter* local_conv_param) {
  delete local_conv_param_;
  local_conv_param_ = local_conv_param;
  if (local_conv_param) {
    set_has_local_conv_param();
  } else {
    clear_has_local_conv_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.local_conv_param)
}
...
// optional .caffe.EuclideanNewLossLayerParam euclidean_new_loss_param = 161;
inline bool LayerParameter::has_euclidean_new_loss_param() const {
  return (_has_bits_[1] & 0x10000000u) != 0;
}
inline void LayerParameter::set_has_euclidean_new_loss_param() {
  _has_bits_[1] |= 0x10000000u;
}
inline void LayerParameter::clear_has_euclidean_new_loss_param() {
  _has_bits_[1] &= ~0x10000000u;
}
inline void LayerParameter::clear_euclidean_new_loss_param() {
  if (euclidean_new_loss_param_ != NULL) euclidean_new_loss_param_->::caffe::EuclideanNewLossLayerParam::Clear();
  clear_has_euclidean_new_loss_param();
}
inline const ::caffe::EuclideanNewLossLayerParam& LayerParameter::euclidean_new_loss_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.euclidean_new_loss_param)
  return euclidean_new_loss_param_ != NULL ? *euclidean_new_loss_param_ : *default_instance_->euclidean_new_loss_param_;
}
inline ::caffe::EuclideanNewLossLayerParam* LayerParameter::mutable_euclidean_new_loss_param() {
  set_has_euclidean_new_loss_param();
  if (euclidean_new_loss_param_ == NULL) euclidean_new_loss_param_ = new ::caffe::EuclideanNewLossLayerParam;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.euclidean_new_loss_param)
  return euclidean_new_loss_param_;
}
inline ::caffe::EuclideanNewLossLayerParam* LayerParameter::release_euclidean_new_loss_param() {
  clear_has_euclidean_new_loss_param();
  ::caffe::EuclideanNewLossLayerParam* temp = euclidean_new_loss_param_;
  euclidean_new_loss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_euclidean_new_loss_param(::caffe::EuclideanNewLossLayerParam* euclidean_new_loss_param) {
  delete euclidean_new_loss_param_;
  euclidean_new_loss_param_ = euclidean_new_loss_param;
  if (euclidean_new_loss_param) {
    set_has_euclidean_new_loss_param();
  } else {
    clear_has_euclidean_new_loss_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.euclidean_new_loss_param)
}
...
// optional int32 average_span = 3 [default = 10];
inline bool BNParameter::has_average_span() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void BNParameter::set_has_average_span() {
  _has_bits_[0] |= 0x00000004u;
}
inline void BNParameter::clear_has_average_span() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void BNParameter::clear_average_span() {
  average_span_ = 10;
  clear_has_average_span();
}
inline ::google::protobuf::int32 BNParameter::average_span() const {
  // @@protoc_insertion_point(field_get:caffe.BNParameter.average_span)
  return average_span_;
}
inline void BNParameter::set_average_span(::google::protobuf::int32 value) {
  set_has_average_span();
  average_span_ = value;
  // @@protoc_insertion_point(field_set:caffe.BNParameter.average_span)
}

// optional float exponential_average_weight = 4 [default = 0.001];
inline bool BNParameter::has_exponential_average_weight() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void BNParameter::set_has_exponential_average_weight() {
  _has_bits_[0] |= 0x00000008u;
}
inline void BNParameter::clear_has_exponential_average_weight() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void BNParameter::clear_exponential_average_weight() {
  exponential_average_weight_ = 0.001f;
  clear_has_exponential_average_weight();
}
inline float BNParameter::exponential_average_weight() const {
  // @@protoc_insertion_point(field_get:caffe.BNParameter.exponential_average_weight)
  return exponential_average_weight_;
}
inline void BNParameter::set_exponential_average_weight(float value) {
  set_has_exponential_average_weight();
  exponential_average_weight_ = value;
  // @@protoc_insertion_point(field_set:caffe.BNParameter.exponential_average_weight)
}

// optional .caffe.BNParameter.Type bn_type = 5 [default = CHANNEL_WISE];
inline bool BNParameter::has_bn_type() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void BNParameter::set_has_bn_type() {
  _has_bits_[0] |= 0x00000010u;
}
inline void BNParameter::clear_has_bn_type() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void BNParameter::clear_bn_type() {
  bn_type_ = 0;
  clear_has_bn_type();
}
inline ::caffe::BNParameter_Type BNParameter::bn_type() const {
  // @@protoc_insertion_point(field_get:caffe.BNParameter.bn_type)
  return static_cast< ::caffe::BNParameter_Type >(bn_type_);
}
inline void BNParameter::set_bn_type(::caffe::BNParameter_Type value) {
  assert(::caffe::BNParameter_Type_IsValid(value));
  set_has_bn_type();
  bn_type_ = value;
  // @@protoc_insertion_point(field_set:caffe.BNParameter.bn_type)
}
...
// optional uint32 num_output = 1;
inline bool LocalConvolutionParameter::has_num_output() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void LocalConvolutionParameter::set_has_num_output() {
  _has_bits_[0] |= 0x00000001u;
}
inline void LocalConvolutionParameter::clear_has_num_output() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void LocalConvolutionParameter::clear_num_output() {
  num_output_ = 0u;
  clear_has_num_output();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::num_output() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.num_output)
  return num_output_;
}
inline void LocalConvolutionParameter::set_num_output(::google::protobuf::uint32 value) {
  set_has_num_output();
  num_output_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.num_output)
}

// optional bool bias_term = 2 [default = true];
inline bool LocalConvolutionParameter::has_bias_term() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void LocalConvolutionParameter::set_has_bias_term() {
  _has_bits_[0] |= 0x00000002u;
}
inline void LocalConvolutionParameter::clear_has_bias_term() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void LocalConvolutionParameter::clear_bias_term() {
  bias_term_ = true;
  clear_has_bias_term();
}
inline bool LocalConvolutionParameter::bias_term() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.bias_term)
  return bias_term_;
}
inline void LocalConvolutionParameter::set_bias_term(bool value) {
  set_has_bias_term();
  bias_term_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.bias_term)
}

// optional uint32 pad = 3 [default = 0];
inline bool LocalConvolutionParameter::has_pad() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void LocalConvolutionParameter::set_has_pad() {
  _has_bits_[0] |= 0x00000004u;
}
inline void LocalConvolutionParameter::clear_has_pad() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void LocalConvolutionParameter::clear_pad() {
  pad_ = 0u;
  clear_has_pad();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::pad() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.pad)
  return pad_;
}
inline void LocalConvolutionParameter::set_pad(::google::protobuf::uint32 value) {
  set_has_pad();
  pad_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.pad)
}

// optional uint32 pad_h = 9 [default = 0];
inline bool LocalConvolutionParameter::has_pad_h() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void LocalConvolutionParameter::set_has_pad_h() {
  _has_bits_[0] |= 0x00000008u;
}
inline void LocalConvolutionParameter::clear_has_pad_h() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void LocalConvolutionParameter::clear_pad_h() {
  pad_h_ = 0u;
  clear_has_pad_h();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::pad_h() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.pad_h)
  return pad_h_;
}
inline void LocalConvolutionParameter::set_pad_h(::google::protobuf::uint32 value) {
  set_has_pad_h();
  pad_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.pad_h)
}

// optional uint32 pad_w = 10 [default = 0];
inline bool LocalConvolutionParameter::has_pad_w() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void LocalConvolutionParameter::set_has_pad_w() {
  _has_bits_[0] |= 0x00000010u;
}
inline void LocalConvolutionParameter::clear_has_pad_w() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void LocalConvolutionParameter::clear_pad_w() {
  pad_w_ = 0u;
  clear_has_pad_w();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::pad_w() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.pad_w)
  return pad_w_;
}
inline void LocalConvolutionParameter::set_pad_w(::google::protobuf::uint32 value) {
  set_has_pad_w();
  pad_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.pad_w)
}

// optional uint32 kernel_size = 4;
inline bool LocalConvolutionParameter::has_kernel_size() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void LocalConvolutionParameter::set_has_kernel_size() {
  _has_bits_[0] |= 0x00000020u;
}
inline void LocalConvolutionParameter::clear_has_kernel_size() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void LocalConvolutionParameter::clear_kernel_size() {
  kernel_size_ = 0u;
  clear_has_kernel_size();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::kernel_size() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.kernel_size)
  return kernel_size_;
}
inline void LocalConvolutionParameter::set_kernel_size(::google::protobuf::uint32 value) {
  set_has_kernel_size();
  kernel_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.kernel_size)
}

// optional uint32 kernel_h = 11;
inline bool LocalConvolutionParameter::has_kernel_h() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void LocalConvolutionParameter::set_has_kernel_h() {
  _has_bits_[0] |= 0x00000040u;
}
inline void LocalConvolutionParameter::clear_has_kernel_h() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void LocalConvolutionParameter::clear_kernel_h() {
  kernel_h_ = 0u;
  clear_has_kernel_h();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::kernel_h() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.kernel_h)
  return kernel_h_;
}
inline void LocalConvolutionParameter::set_kernel_h(::google::protobuf::uint32 value) {
  set_has_kernel_h();
  kernel_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.kernel_h)
}

// optional uint32 kernel_w = 12;
inline bool LocalConvolutionParameter::has_kernel_w() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void LocalConvolutionParameter::set_has_kernel_w() {
  _has_bits_[0] |= 0x00000080u;
}
inline void LocalConvolutionParameter::clear_has_kernel_w() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void LocalConvolutionParameter::clear_kernel_w() {
  kernel_w_ = 0u;
  clear_has_kernel_w();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::kernel_w() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.kernel_w)
  return kernel_w_;
}
inline void LocalConvolutionParameter::set_kernel_w(::google::protobuf::uint32 value) {
  set_has_kernel_w();
  kernel_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.kernel_w)
}

// optional uint32 group = 5 [default = 1];
inline bool LocalConvolutionParameter::has_group() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void LocalConvolutionParameter::set_has_group() {
  _has_bits_[0] |= 0x00000100u;
}
inline void LocalConvolutionParameter::clear_has_group() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void LocalConvolutionParameter::clear_group() {
  group_ = 1u;
  clear_has_group();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::group() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.group)
  return group_;
}
inline void LocalConvolutionParameter::set_group(::google::protobuf::uint32 value) {
  set_has_group();
  group_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.group)
}

// optional uint32 stride = 6 [default = 1];
inline bool LocalConvolutionParameter::has_stride() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void LocalConvolutionParameter::set_has_stride() {
  _has_bits_[0] |= 0x00000200u;
}
inline void LocalConvolutionParameter::clear_has_stride() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void LocalConvolutionParameter::clear_stride() {
  stride_ = 1u;
  clear_has_stride();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::stride() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.stride)
  return stride_;
}
inline void LocalConvolutionParameter::set_stride(::google::protobuf::uint32 value) {
  set_has_stride();
  stride_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.stride)
}

// optional uint32 stride_h = 13;
inline bool LocalConvolutionParameter::has_stride_h() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void LocalConvolutionParameter::set_has_stride_h() {
  _has_bits_[0] |= 0x00000400u;
}
inline void LocalConvolutionParameter::clear_has_stride_h() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void LocalConvolutionParameter::clear_stride_h() {
  stride_h_ = 0u;
  clear_has_stride_h();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::stride_h() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.stride_h)
  return stride_h_;
}
inline void LocalConvolutionParameter::set_stride_h(::google::protobuf::uint32 value) {
  set_has_stride_h();
  stride_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.stride_h)
}

// optional uint32 stride_w = 14;
inline bool LocalConvolutionParameter::has_stride_w() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void LocalConvolutionParameter::set_has_stride_w() {
  _has_bits_[0] |= 0x00000800u;
}
inline void LocalConvolutionParameter::clear_has_stride_w() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void LocalConvolutionParameter::clear_stride_w() {
  stride_w_ = 0u;
  clear_has_stride_w();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::stride_w() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.stride_w)
  return stride_w_;
}
inline void LocalConvolutionParameter::set_stride_w(::google::protobuf::uint32 value) {
  set_has_stride_w();
  stride_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.stride_w)
}

// repeated uint32 dilation = 25;
inline int LocalConvolutionParameter::dilation_size() const {
  return dilation_.size();
}
inline void LocalConvolutionParameter::clear_dilation() {
  dilation_.Clear();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::dilation(int index) const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.dilation)
  return dilation_.Get(index);
}
inline void LocalConvolutionParameter::set_dilation(int index, ::google::protobuf::uint32 value) {
  dilation_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.dilation)
}
inline void LocalConvolutionParameter::add_dilation(::google::protobuf::uint32 value) {
  dilation_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.LocalConvolutionParameter.dilation)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
LocalConvolutionParameter::dilation() const {
  // @@protoc_insertion_point(field_list:caffe.LocalConvolutionParameter.dilation)
  return dilation_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
LocalConvolutionParameter::mutable_dilation() {
  // @@protoc_insertion_point(field_mutable_list:caffe.LocalConvolutionParameter.dilation)
  return &dilation_;
}

// optional .caffe.FillerParameter weight_filler = 7;
inline bool LocalConvolutionParameter::has_weight_filler() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void LocalConvolutionParameter::set_has_weight_filler() {
  _has_bits_[0] |= 0x00002000u;
}
inline void LocalConvolutionParameter::clear_has_weight_filler() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void LocalConvolutionParameter::clear_weight_filler() {
  if (weight_filler_ != NULL) weight_filler_->::caffe::FillerParameter::Clear();
  clear_has_weight_filler();
}
inline const ::caffe::FillerParameter& LocalConvolutionParameter::weight_filler() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.weight_filler)
  return weight_filler_ != NULL ? *weight_filler_ : *default_instance_->weight_filler_;
}
inline ::caffe::FillerParameter* LocalConvolutionParameter::mutable_weight_filler() {
  set_has_weight_filler();
  if (weight_filler_ == NULL) weight_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LocalConvolutionParameter.weight_filler)
  return weight_filler_;
}
inline ::caffe::FillerParameter* LocalConvolutionParameter::release_weight_filler() {
  clear_has_weight_filler();
  ::caffe::FillerParameter* temp = weight_filler_;
  weight_filler_ = NULL;
  return temp;
}
inline void LocalConvolutionParameter::set_allocated_weight_filler(::caffe::FillerParameter* weight_filler) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.LocalConvolutionParameter.weight_filler)
}

// optional .caffe.FillerParameter bias_filler = 8;
inline bool LocalConvolutionParameter::has_bias_filler() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void LocalConvolutionParameter::set_has_bias_filler() {
  _has_bits_[0] |= 0x00004000u;
}
inline void LocalConvolutionParameter::clear_has_bias_filler() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void LocalConvolutionParameter::clear_bias_filler() {
  if (bias_filler_ != NULL) bias_filler_->::caffe::FillerParameter::Clear();
  clear_has_bias_filler();
}
inline const ::caffe::FillerParameter& LocalConvolutionParameter::bias_filler() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.bias_filler)
  return bias_filler_ != NULL ? *bias_filler_ : *default_instance_->bias_filler_;
}
inline ::caffe::FillerParameter* LocalConvolutionParameter::mutable_bias_filler() {
  set_has_bias_filler();
  if (bias_filler_ == NULL) bias_filler_ = new ::caffe::FillerParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LocalConvolutionParameter.bias_filler)
  return bias_filler_;
}
inline ::caffe::FillerParameter* LocalConvolutionParameter::release_bias_filler() {
  clear_has_bias_filler();
  ::caffe::FillerParameter* temp = bias_filler_;
  bias_filler_ = NULL;
  return temp;
}
inline void LocalConvolutionParameter::set_allocated_bias_filler(::caffe::FillerParameter* bias_filler) {
  delete bias_filler_;
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.LocalConvolutionParameter.bias_filler)
}

// optional .caffe.LocalConvolutionParameter.Engine engine = 15 [default = DEFAULT];
inline bool LocalConvolutionParameter::has_engine() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void LocalConvolutionParameter::set_has_engine() {
  _has_bits_[0] |= 0x00008000u;
}
inline void LocalConvolutionParameter::clear_has_engine() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void LocalConvolutionParameter::clear_engine() {
  engine_ = 0;
  clear_has_engine();
}
inline ::caffe::LocalConvolutionParameter_Engine LocalConvolutionParameter::engine() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.engine)
  return static_cast< ::caffe::LocalConvolutionParameter_Engine >(engine_);
}
inline void LocalConvolutionParameter::set_engine(::caffe::LocalConvolutionParameter_Engine value) {
  assert(::caffe::LocalConvolutionParameter_Engine_IsValid(value));
  set_has_engine();
  engine_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.engine)
}

// optional uint32 local_region_number = 16 [default = 1];
inline bool LocalConvolutionParameter::has_local_region_number() const {
  return (_has_bits_[0] & 0x00010000u) != 0;
}
inline void LocalConvolutionParameter::set_has_local_region_number() {
  _has_bits_[0] |= 0x00010000u;
}
inline void LocalConvolutionParameter::clear_has_local_region_number() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void LocalConvolutionParameter::clear_local_region_number() {
  local_region_number_ = 1u;
  clear_has_local_region_number();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::local_region_number() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.local_region_number)
  return local_region_number_;
}
inline void LocalConvolutionParameter::set_local_region_number(::google::protobuf::uint32 value) {
  set_has_local_region_number();
  local_region_number_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.local_region_number)
}

// optional uint32 local_region_number_w = 17 [default = 1];
inline bool LocalConvolutionParameter::has_local_region_number_w() const {
  return (_has_bits_[0] & 0x00020000u) != 0;
}
inline void LocalConvolutionParameter::set_has_local_region_number_w() {
  _has_bits_[0] |= 0x00020000u;
}
inline void LocalConvolutionParameter::clear_has_local_region_number_w() {
  _has_bits_[0] &= ~0x00020000u;
}
inline void LocalConvolutionParameter::clear_local_region_number_w() {
  local_region_number_w_ = 1u;
  clear_has_local_region_number_w();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::local_region_number_w() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.local_region_number_w)
  return local_region_number_w_;
}
inline void LocalConvolutionParameter::set_local_region_number_w(::google::protobuf::uint32 value) {
  set_has_local_region_number_w();
  local_region_number_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.local_region_number_w)
}

// optional uint32 local_region_number_h = 18 [default = 1];
inline bool LocalConvolutionParameter::has_local_region_number_h() const {
  return (_has_bits_[0] & 0x00040000u) != 0;
}
inline void LocalConvolutionParameter::set_has_local_region_number_h() {
  _has_bits_[0] |= 0x00040000u;
}
inline void LocalConvolutionParameter::clear_has_local_region_number_h() {
  _has_bits_[0] &= ~0x00040000u;
}
inline void LocalConvolutionParameter::clear_local_region_number_h() {
  local_region_number_h_ = 1u;
  clear_has_local_region_number_h();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::local_region_number_h() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.local_region_number_h)
  return local_region_number_h_;
}
inline void LocalConvolutionParameter::set_local_region_number_h(::google::protobuf::uint32 value) {
  set_has_local_region_number_h();
  local_region_number_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.local_region_number_h)
}

// optional float local_region_ratio = 19 [default = 1];
inline bool LocalConvolutionParameter::has_local_region_ratio() const {
  return (_has_bits_[0] & 0x00080000u) != 0;
}
inline void LocalConvolutionParameter::set_has_local_region_ratio() {
  _has_bits_[0] |= 0x00080000u;
}
inline void LocalConvolutionParameter::clear_has_local_region_ratio() {
  _has_bits_[0] &= ~0x00080000u;
}
inline void LocalConvolutionParameter::clear_local_region_ratio() {
  local_region_ratio_ = 1;
  clear_has_local_region_ratio();
}
inline float LocalConvolutionParameter::local_region_ratio() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.local_region_ratio)
  return local_region_ratio_;
}
inline void LocalConvolutionParameter::set_local_region_ratio(float value) {
  set_has_local_region_ratio();
  local_region_ratio_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.local_region_ratio)
}

// optional float local_region_ratio_w = 20 [default = 1];
inline bool LocalConvolutionParameter::has_local_region_ratio_w() const {
  return (_has_bits_[0] & 0x00100000u) != 0;
}
inline void LocalConvolutionParameter::set_has_local_region_ratio_w() {
  _has_bits_[0] |= 0x00100000u;
}
inline void LocalConvolutionParameter::clear_has_local_region_ratio_w() {
  _has_bits_[0] &= ~0x00100000u;
}
inline void LocalConvolutionParameter::clear_local_region_ratio_w() {
  local_region_ratio_w_ = 1;
  clear_has_local_region_ratio_w();
}
inline float LocalConvolutionParameter::local_region_ratio_w() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.local_region_ratio_w)
  return local_region_ratio_w_;
}
inline void LocalConvolutionParameter::set_local_region_ratio_w(float value) {
  set_has_local_region_ratio_w();
  local_region_ratio_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.local_region_ratio_w)
}

// optional float local_region_ratio_h = 21 [default = 1];
inline bool LocalConvolutionParameter::has_local_region_ratio_h() const {
  return (_has_bits_[0] & 0x00200000u) != 0;
}
inline void LocalConvolutionParameter::set_has_local_region_ratio_h() {
  _has_bits_[0] |= 0x00200000u;
}
inline void LocalConvolutionParameter::clear_has_local_region_ratio_h() {
  _has_bits_[0] &= ~0x00200000u;
}
inline void LocalConvolutionParameter::clear_local_region_ratio_h() {
  local_region_ratio_h_ = 1;
  clear_has_local_region_ratio_h();
}
inline float LocalConvolutionParameter::local_region_ratio_h() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.local_region_ratio_h)
  return local_region_ratio_h_;
}
inline void LocalConvolutionParameter::set_local_region_ratio_h(float value) {
  set_has_local_region_ratio_h();
  local_region_ratio_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.local_region_ratio_h)
}

// optional uint32 local_region_step = 22 [default = 1];
inline bool LocalConvolutionParameter::has_local_region_step() const {
  return (_has_bits_[0] & 0x00400000u) != 0;
}
inline void LocalConvolutionParameter::set_has_local_region_step() {
  _has_bits_[0] |= 0x00400000u;
}
inline void LocalConvolutionParameter::clear_has_local_region_step() {
  _has_bits_[0] &= ~0x00400000u;
}
inline void LocalConvolutionParameter::clear_local_region_step() {
  local_region_step_ = 1u;
  clear_has_local_region_step();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::local_region_step() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.local_region_step)
  return local_region_step_;
}
inline void LocalConvolutionParameter::set_local_region_step(::google::protobuf::uint32 value) {
  set_has_local_region_step();
  local_region_step_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.local_region_step)
}

// optional uint32 local_region_step_w = 23 [default = 1];
inline bool LocalConvolutionParameter::has_local_region_step_w() const {
  return (_has_bits_[0] & 0x00800000u) != 0;
}
inline void LocalConvolutionParameter::set_has_local_region_step_w() {
  _has_bits_[0] |= 0x00800000u;
}
inline void LocalConvolutionParameter::clear_has_local_region_step_w() {
  _has_bits_[0] &= ~0x00800000u;
}
inline void LocalConvolutionParameter::clear_local_region_step_w() {
  local_region_step_w_ = 1u;
  clear_has_local_region_step_w();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::local_region_step_w() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.local_region_step_w)
  return local_region_step_w_;
}
inline void LocalConvolutionParameter::set_local_region_step_w(::google::protobuf::uint32 value) {
  set_has_local_region_step_w();
  local_region_step_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.local_region_step_w)
}

// optional uint32 local_region_step_h = 24 [default = 1];
inline bool LocalConvolutionParameter::has_local_region_step_h() const {
  return (_has_bits_[0] & 0x01000000u) != 0;
}
inline void LocalConvolutionParameter::set_has_local_region_step_h() {
  _has_bits_[0] |= 0x01000000u;
}
inline void LocalConvolutionParameter::clear_has_local_region_step_h() {
  _has_bits_[0] &= ~0x01000000u;
}
inline void LocalConvolutionParameter::clear_local_region_step_h() {
  local_region_step_h_ = 1u;
  clear_has_local_region_step_h();
}
inline ::google::protobuf::uint32 LocalConvolutionParameter::local_region_step_h() const {
  // @@protoc_insertion_point(field_get:caffe.LocalConvolutionParameter.local_region_step_h)
  return local_region_step_h_;
}
inline void LocalConvolutionParameter::set_local_region_step_h(::google::protobuf::uint32 value) {
  set_has_local_region_step_h();
  local_region_step_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.LocalConvolutionParameter.local_region_step_h)
}
...
// optional uint32 task_num = 11 [default = 1];
inline bool DataParameter::has_task_num() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void DataParameter::set_has_task_num() {
  _has_bits_[0] |= 0x00000400u;
}
inline void DataParameter::clear_has_task_num() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void DataParameter::clear_task_num() {
  task_num_ = 1u;
  clear_has_task_num();
}
inline ::google::protobuf::uint32 DataParameter::task_num() const {
  // @@protoc_insertion_point(field_get:caffe.DataParameter.task_num)
  return task_num_;
}
inline void DataParameter::set_task_num(::google::protobuf::uint32 value) {
  set_has_task_num();
  task_num_ = value;
  // @@protoc_insertion_point(field_set:caffe.DataParameter.task_num)
}

// repeated uint32 label_dimension = 12;
inline int DataParameter::label_dimension_size() const {
  return label_dimension_.size();
}
inline void DataParameter::clear_label_dimension() {
  label_dimension_.Clear();
}
inline ::google::protobuf::uint32 DataParameter::label_dimension(int index) const {
  // @@protoc_insertion_point(field_get:caffe.DataParameter.label_dimension)
  return label_dimension_.Get(index);
}
inline void DataParameter::set_label_dimension(int index, ::google::protobuf::uint32 value) {
  label_dimension_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.DataParameter.label_dimension)
}
inline void DataParameter::add_label_dimension(::google::protobuf::uint32 value) {
  label_dimension_.Add(value);
  // @@protoc_insertion_point(field_add:caffe.DataParameter.label_dimension)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
DataParameter::label_dimension() const {
  // @@protoc_insertion_point(field_list:caffe.DataParameter.label_dimension)
  return label_dimension_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
DataParameter::mutable_label_dimension() {
  // @@protoc_insertion_point(field_mutable_list:caffe.DataParameter.label_dimension)
  return &label_dimension_;
}
...
// optional int32 net_size = 1 [default = 5];
inline bool EuclideanNewLossLayerParam::has_net_size() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void EuclideanNewLossLayerParam::set_has_net_size() {
  _has_bits_[0] |= 0x00000001u;
}
inline void EuclideanNewLossLayerParam::clear_has_net_size() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void EuclideanNewLossLayerParam::clear_net_size() {
  net_size_ = 5;
  clear_has_net_size();
}
inline ::google::protobuf::int32 EuclideanNewLossLayerParam::net_size() const {
  // @@protoc_insertion_point(field_get:caffe.EuclideanNewLossLayerParam.net_size)
  return net_size_;
}
inline void EuclideanNewLossLayerParam::set_net_size(::google::protobuf::int32 value) {
  set_has_net_size();
  net_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.EuclideanNewLossLayerParam.net_size)
}
...
template <> struct is_proto_enum< ::caffe::BNParameter_Type> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::BNParameter_Type>() {
  return ::caffe::BNParameter_Type_descriptor();
}
template <> struct is_proto_enum< ::caffe::LocalConvolutionParameter_Engine> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::LocalConvolutionParameter_Engine>() {
  return ::caffe::LocalConvolutionParameter_Engine_descriptor();
}
